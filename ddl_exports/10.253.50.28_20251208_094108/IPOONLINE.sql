...
-- Server: 10.253.50.28
-- Database: IPOONLINE
-- Exported: 2025-12-08T09:41:47.214389
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__BRANCH_MASTER__367C1819] ON [dbo].[BRANCH_MASTER] ([BM_CODE])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__CLIENT_CASH_BALA__339FAB6E] ON [dbo].[CLIENT_CASH_BALANCE] ([CCB_CM_ID])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__CLIENT_MASTER__30C33EC3] ON [dbo].[CLIENT_MASTER] ([CM_UM_ID])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__IPO_MASTER__3B40CD36] ON [dbo].[IPO_MASTER] ([IM_IPO_SYMBOL])
...
-- INDEX dbo.IPO_MASTER
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__IPO_MASTER__3C34F16F] ON [dbo].[IPO_MASTER] ([IM_IPO_NAME])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__SUBBROKER_MASTER__2DE6D218] ON [dbo].[SUBBROKER_MASTER] ([SBM_CODE])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [categoryidx] ON [dbo].[TBLCATEGORY] ([fldcategorycode])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IDXLOGIN] ON [dbo].[TBLCLASSUSERLOGINS] ([FLDUSERNAME], [FLDSESSION], [FLDIPADDRESS])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [AutoIDx] ON [dbo].[TBLUSERCONTROLMASTER] ([FLDAUTO])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__USER_MASTER__2B0A656D] ON [dbo].[USER_MASTER] ([UM_CODE])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IDXUSER] ON [dbo].[V2_LOGIN_LOG] ([ADDDT], [USERID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [idxReport] ON [dbo].[V2_Report_Access_Log] ([Sno])
