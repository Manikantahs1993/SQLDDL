...
-- Server: 10.253.50.28
-- Database: PRADNYA
-- Exported: 2025-12-08T09:42:10.858849
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [IX_CHARTSPECS] ON [dbo].[CHARTSPECS] ([REPORTCODE])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [idxcd] ON [dbo].[CLS_F2CONFIG] ([F2CODE])
