...
-- Server: 10.253.50.28
-- Database: DBA_Admin
-- Exported: 2025-12-08T09:41:34.962936
...
-- INDEX dbo.db_size_daily_report
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IXNC1_db_size_daily_report] ON [dbo].[db_size_daily_report] ([collection_time], [server_name], [file_drive])
...
-- INDEX dbo.performance_counters
-- --------------------------------------------------
CREATE CLUSTERED INDEX [nci_counter_collection_time_utc] ON [dbo].[performance_counters] ([counter], [collection_time_utc])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [uq_resource_consumption] ON [dbo].[resource_consumption] ([start_time], [event_time], [row_id])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [uq_xevent_metrics] ON [dbo].[xevent_metrics] ([start_time], [event_time], [row_id])
