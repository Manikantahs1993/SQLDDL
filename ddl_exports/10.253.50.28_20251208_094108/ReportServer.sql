...
-- Exported: 2025-12-08T09:42:12.039105
...
-- INDEX dbo.Batch
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Batch_1] ON [dbo].[Batch] ([AddedOn])
...
-- INDEX dbo.Catalog
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ComponentLookup] ON [dbo].[Catalog] ([Type], [ComponentID])
...
-- INDEX dbo.Catalog
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DatasetLookup] ON [dbo].[Catalog] ([Type], [ItemID])
...
-- INDEX dbo.Catalog
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Link] ON [dbo].[Catalog] ([LinkSourceID])
...
-- INDEX dbo.Catalog
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Parent] ON [dbo].[Catalog] ([ParentID])
...
-- INDEX dbo.Catalog
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Policy] ON [dbo].[Catalog] ([PolicyID])
...
-- INDEX dbo.Catalog
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SnapshotDataId] ON [dbo].[Catalog] ([SnapshotDataID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ItemId_CatalogItemExtendedContent] ON [dbo].[CatalogItemExtendedContent] ([ItemId], [ContentType])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ChunkSegmentMapping_SegmentId] ON [dbo].[ChunkSegmentMapping] ([SegmentId])
...
-- INDEX dbo.ChunkSegmentMapping
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UNIQ_ChunkId_StartByte] ON [dbo].[ChunkSegmentMapping] ([ChunkId], [StartByte]) INCLUDE ([ActualByteCount], [LogicalByteCount])
...
-- INDEX dbo.Comments
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Comments_Item] ON [dbo].[Comments] ([ItemID])
...
-- INDEX dbo.Comments
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Comments_Thread] ON [dbo].[Comments] ([ThreadID])
...
-- INDEX dbo.Comments
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Comments_User] ON [dbo].[Comments] ([UserID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataModelDataSource] ON [dbo].[DataModelDataSource] ([ItemId])
...
-- INDEX dbo.DataModelDataSource
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataModelDataSource_DataSourceID] ON [dbo].[DataModelDataSource] ([DataSourceID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataModelRole_ItemID] ON [dbo].[DataModelRole] ([ItemID])
...
-- INDEX dbo.DataSets
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataSetLinkID] ON [dbo].[DataSets] ([LinkID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataSourceItemID] ON [dbo].[DataSource] ([ItemID])
...
-- INDEX dbo.DataSource
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataSourceSubscriptionID] ON [dbo].[DataSource] ([SubscriptionID])
...
-- INDEX dbo.DataSource
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UQ__DataSour__F19B4C9D808AC546] ON [dbo].[DataSource] ([DSIDNum])
...
-- INDEX dbo.Event
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Event_TimeEntered] ON [dbo].[Event] ([TimeEntered])
...
-- INDEX dbo.Event
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Event2] ON [dbo].[Event] ([ProcessStart])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ExecutionLog] ON [dbo].[ExecutionLogStorage] ([TimeStart], [LogEntryId])
...
-- INDEX dbo.History
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SnapshotDataID] ON [dbo].[History] ([SnapshotDataID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Notifications] ON [dbo].[Notifications] ([ProcessAfter])
...
-- INDEX dbo.Notifications
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Notifications2] ON [dbo].[Notifications] ([ProcessStart])
...
-- INDEX dbo.Notifications
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Notifications3] ON [dbo].[Notifications] ([NotificationEntered])
...
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [IX_ProductInfoHistory_DateTime] ON [dbo].[ProductInfoHistory] ([DateTime])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ReportSchedule_ReportID] ON [dbo].[ReportSchedule] ([ReportID])
...
-- INDEX dbo.ReportSchedule
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ReportSchedule_ScheduleID] ON [dbo].[ReportSchedule] ([ScheduleID])
...
-- INDEX dbo.ReportSchedule
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ReportSchedule_SubscriptionID] ON [dbo].[ReportSchedule] ([SubscriptionID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_RunningJobsStatus] ON [dbo].[RunningJobs] ([ComputerName], [JobType])
...
-- INDEX dbo.Schedule
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [IX_Schedule] ON [dbo].[Schedule] ([Name], [Path])
...
-- INDEX dbo.Schedule
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ScheduleForListTask] ON [dbo].[Schedule] ([Type], [Path], [CreatedById]) INCLUDE ([Name], [StartDate], [Flags], [NextRunTime], [LastRunTime], [EndDate], [RecurrenceType], [MinutesInterval], [DaysInterval], [WeeksInterval], [DaysOfWeek], [DaysOfMonth], [Month], [MonthlyWeek], [State], [LastRunStatus], [ScheduledRunTimeout], [EventType], [EventData])
...
-- INDEX dbo.SecData
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SecData_NtSecDescState] ON [dbo].[SecData] ([NtSecDescState])
...
-- INDEX dbo.Segment
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [IX_SegmentMetadata] ON [dbo].[Segment] ([SegmentId])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ChunkId_SnapshotDataId] ON [dbo].[SegmentedChunk] ([ChunkId], [SnapshotDataId])
...
-- INDEX dbo.SegmentedChunk
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UNIQ_SnapshotChunkMapping] ON [dbo].[SegmentedChunk] ([SnapshotDataId], [ChunkType], [ChunkName]) INCLUDE ([ChunkFlags], [ChunkId])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ServerParametersInstanceExpiration] ON [dbo].[ServerParametersInstance] ([Expiration])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SnapshotCleaning] ON [dbo].[SnapshotData] ([PermanentRefcount])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SubscriptionHistorySubscriptionID] ON [dbo].[SubscriptionHistory] ([SubscriptionID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SubscriptionResults] ON [dbo].[SubscriptionResults] ([SubscriptionID], [ExtensionSettingsHash])
