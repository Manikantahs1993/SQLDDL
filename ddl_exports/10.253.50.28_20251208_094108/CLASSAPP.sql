...
-- Server: 10.253.50.28
-- Database: CLASSAPP
-- Exported: 2025-12-08T09:41:32.058624
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [PASSPORT_IDX_CLS] ON [dbo].[PASSPORT_LOGIN_MAP] ([CLASS_LOGIN], [APP_CODE])
...
-- INDEX dbo.PASSPORT_LOGIN_MAP
-- --------------------------------------------------
CREATE CLUSTERED INDEX [PASSPORT_IDX_MAP] ON [dbo].[PASSPORT_LOGIN_MAP] ([MAPPED_LOGIN], [APP_CODE])
