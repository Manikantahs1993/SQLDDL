...
-- Exported: 2025-12-08T09:42:12.585811
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ContentCache] ON [dbo].[ContentCache] ([CatalogItemID], [ParamsHash], [ContentType])
...
-- INDEX dbo.ContentCache
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ContentCache_ExpirationDate] ON [dbo].[ContentCache] ([ExpirationDate])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_CacheLookup] ON [dbo].[ExecutionCache] ([ReportID], [ParamsHash], [AbsoluteExpiration]) INCLUDE ([SnapshotDataID])
...
-- INDEX dbo.ExecutionCache
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_ExecutionCacheLastUsed] ON [dbo].[ExecutionCache] ([ReportID], [AbsoluteExpiration], [LastUsedTime], [ExecutionCacheID])
...
-- INDEX dbo.ExecutionCache
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SnapshotDataID] ON [dbo].[ExecutionCache] ([SnapshotDataID])
...
-- INDEX dbo.SessionData
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_EditSessionID] ON [dbo].[SessionData] ([EditSessionID])
...
-- INDEX dbo.SessionData
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SessionCleanup] ON [dbo].[SessionData] ([Expiration])
...
-- INDEX dbo.SessionData
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SessionSnapshotID] ON [dbo].[SessionData] ([SnapshotDataID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IS_SnapshotExpiration] ON [dbo].[SnapshotData] ([PermanentRefcount], [ExpirationDate])
...
-- INDEX dbo.SnapshotData
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_SnapshotCleaning] ON [dbo].[SnapshotData] ([PermanentRefcount], [TransientRefcount]) INCLUDE ([Machine])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_Cleanup] ON [dbo].[TempCatalog] ([ExpirationTime])
...
-- INDEX dbo.TempCatalog
-- --------------------------------------------------
CREATE UNIQUE CLUSTERED INDEX [UNIQ_TempCatalogID] ON [dbo].[TempCatalog] ([TempCatalogID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataSetLinkID] ON [dbo].[TempDataSets] ([LinkID])
...
-- --------------------------------------------------
CREATE CLUSTERED INDEX [IX_DataSourceItemID] ON [dbo].[TempDataSources] ([ItemID])
